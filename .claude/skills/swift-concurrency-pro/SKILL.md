...
> **Source:** vendored from [twostraws/Swift-Concurrency-Agent-Skill](https://github.com/twostraws/Swift-Concurrency-Agent-Skill) (Paul Hudson, MIT).
> Discovered via Paul Solt's roundup tweet: <https://x.com/PaulSolt/article/2042716870512353294> — check there for updates and the other skill packs.
