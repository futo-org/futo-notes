 ...
 * tags/checkboxes/fences (#102). Those are open parity tickets with their own
 * acceptance criteria — the transition plan's §4 bucket 1 — and writing failing
 * assertions for them here would just be a second copy of the backlog.
 *
