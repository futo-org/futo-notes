...
<div class="markdown-toolbar" style="bottom: {keyboard.height > 0 ? `${keyboard.height}px` : `env(safe-area-inset-bottom, 0px)`}; transform: translateY({keyboard.offsetTop}px)"
