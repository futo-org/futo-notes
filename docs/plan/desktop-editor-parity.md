...
| --- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| D1  | ~~Selection toolbar~~ — FIXED 2026-09-06 (`src/features/editor/milkdown/selectionToolbar/`: Bold / Italic / Strikethrough / Code / Link over Milkdown's tooltip plugin, with a URL field behind Link; `tests/selection-toolbar.spec.ts`). | — | — | — |
| D2  | ~~Slash menu~~ — FIXED in `5bddaf24` (`src/features/editor/milkdown/slash/`, `tests/slash-menu.spec.ts`). | — | — | — |
